...
<!-- show fliters -->
<div id="show_fliter"></div>
<!-- show fliter ends -->

<div class="row text-capitalize" id="explore">
<div class="mt-4">
<h4 class="col-sm-12"> ( {{$teachers->total()}} ) <span class="font_17 text-gray lowercase">tutors available</span></h4>
</div>
...
<a href="{{ route('details',$teacher->id)}}" style="color:gray">
...
<div class="pagination-bar" id="explore_paginate">
<nav>
...
<!-- contents ends -->
<!-- aside start -->
<div class="col-lg-4 col-md-4 col-xs-4 mt-5 page-sidebar">
...
<a href="{{ route('tutor_request')}}" class="btn btn-common mt-3">Find me a tutor</a>
