    ...
    <div class="row mt-1">
        ...
        <div class="col-4">
            ...
            <div class="col-md-5 mt-2">
                <span class="font-weight-bold font-14">{{$class->booking->who_booked->first_name." ".substr($class->booking->who_booked->last_name,0,4)}}</span><br>
                <span class="font-13">{{$class->booking->subject}}.</span><br>
                <span class="font-13 mt-3">{{$class->booking->level}}.</span>
            </div>
            <div class="col-md-4 mt-2 float-right">
                ...
                <span>{{$class->booking->date->format('d')}} {!!substr(date('F', strtotime($class->date)),0,3)!!}. {{$class->booking->date->format('Y')}}</span>
            </div>
            </div> 
        </div>
        @endforeach
