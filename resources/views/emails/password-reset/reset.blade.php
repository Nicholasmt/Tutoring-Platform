                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hello {{$user->first_name}}</h4>
                            <h3 class="mb">No need to worry, you can reset your olukotide password by clicking the link below: <br>
                            <a href="{{ route('password-resst',$user->email)}}" class="button button-primary" target="_blank" rel="noopener" style=""> Reset password</a> <br>
                            Your Email is: {{$user->email}} <br>
                            If you didn't request a password reset, feel free to delete this email and carry on enjoying our platform! <br>
                            All the best,
                           </h3> <br>
                            <p class="mb">Get in touch, via olukotideteam@gmail.com, if there is anything we can help you with </p><br>
                            The Olukotide Team
                         </div>
