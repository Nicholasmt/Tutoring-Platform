                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hi {{$teacher_user->first_name}}</h4>
                             <h3 class="mb">You just been booked by <span class="text-header">{{$booked->who_booked->first_name.' '.$booked->who_booked->last_name}}.  </span>
                             </h3>
                             <p class="mb">  
                               Booked times as follows <br>
                               @if(!is_string(json_decode($booked->booked_times)))

                                 {{date('H:i',strtotime($booked->booked_times))}} 

                               @elseif(is_array(json_decode($booked->booked_times)))

                                 @foreach(json_decode($booked->booked_times) as $time)
                                 {
                                   {{date('H:i',strtotime($time))}} <br>
                               ...
                               <br>
                               Please login to accept/decline below
                             </p>
                         </div>
                                  ...
                                  <tr>
                                     <td align="center" class="td_6">
                                        <table class="table_6" border="0" cellpadding="0" cellspacing="0" role="presentation" >
                                           <tr>
                                             <td style="td_7">
                                                <a href="{{ route('sign-in')}}" class="button button-primary" target="_blank" rel="noopener" style="">Here</a>
                                            </td>
                                           </tr>
                                        </table>
                                     </td>
