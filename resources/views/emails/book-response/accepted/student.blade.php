                      ...
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hi {{$student_user->first_name}}</h4>
                             <h3 class="mb">Your booking with <span class="text-header"> {{$booking->teacher->first_name.' '. $booking->teacher->last_name}},</span> has just been accepted.</h3>
                             <p class="mb"> <br> 
                                Do have a nice class! <br>
                                If there’s anything you need, You can contact our team experts at olukotideteam@gmail.com
                                <br>
                                Thanks
                            </p>
                         </div>
