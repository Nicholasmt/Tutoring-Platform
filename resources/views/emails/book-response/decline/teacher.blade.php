                      ...
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hi {{$teacher_user->first_name}}</h4>
                             <h3 class="mb">You just declined booking from <span class="text-header">{{$booking->who_booked->first_name.' '.$booking->who_booked->last_name}}. </span></h3>
                             <p class="mb">  
                                Note: Often rejection can aftect your overall rating.<br>
                                Get in touch via olukotideteam@gmail.com, If you encounter any issue using our platform,<br> 
                                Thanks.
                             </p>
                         </div>
