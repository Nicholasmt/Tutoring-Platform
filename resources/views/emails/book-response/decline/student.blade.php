                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hi {{$student_user->first_name}}</h4>
                             <h3 class="mb">Your booking with <span class="text-header"> {{$booking->teacher->first_name.' '. $booking->teacher->last_name}},</span>was decline! </h3>
                             <p class="mb">  
                                Reason best known to the teacher, <br>
                                Don't Worry we got you, Find and schedule another tutor below
                                Get in touch via olukotideteam@gmail.com, If you encounter any  issue using our platform,
                                <br> 
                                Thanks.
                             </p>
                         </div>
                                     ...
                                     <td align="center" class="td_6">
                                        <table class="table_6" border="0" cellpadding="0" cellspacing="0" role="presentation" >
                                           <tr>
                                              <td style="td_7">
                                                <td style="td_7">
                                                    <a href="{{ route('explore')}}" class="button button-primary" target="_blank" rel="noopener" style="">Find a Tutor</a>
                                                  </td>
                                              </td>
                                           </tr>
                                        </table>
