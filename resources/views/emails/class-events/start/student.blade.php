                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                             ...
                             <h3 class="mb">Your class session with <span class="text-header"> {{$class_session->booking->teacher->first_name.' '.$class_session->booking->teacher->last_name}}</span> just started.</h3>
                             <p class="mb">Don't miss the class!, Please Login to join,
                             <br>
                              Thanks.
                            </p>
                         </div>
