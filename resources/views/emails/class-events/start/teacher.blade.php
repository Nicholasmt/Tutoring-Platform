                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                             ...
                             <h3 class="mb">You just started class session with {{$class_session->booking->who_booked->first_name.' '.$class_session->booking->who_booked->last_name}} </span></h3>
                             <p class="mb">
                              Get in touch at olukotideteam@gmail.com, If you have any issue
                             <br>
                              Thanks.
                            </p>
                         </div>
