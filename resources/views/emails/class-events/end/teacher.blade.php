                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                             ...
                             <h3 class="mb">Your class session with Student just ended.<span class="text-header"> </span></h3>
                             <p class="mb"> 
                                If there’s anything you need, we are always available via olukotideteam@gmail.com.
                                <br>Help us serve you better.
                             </p>
                         </div>
