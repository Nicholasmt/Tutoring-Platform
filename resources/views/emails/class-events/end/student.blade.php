                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                             ...
                             <h3 class="mb">Your class session with Teacher just ended.<span class="text-header"> </span></h3>
                             <p class="mb">How was your experience,
                             <br>Please Login and give us feedback.</p>
                         </div>
