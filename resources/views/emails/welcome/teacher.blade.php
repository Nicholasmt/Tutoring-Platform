                   ...
                   <td class="content-cell">
                      <!-- Start Body content -->
					    <div class="email-body">
                          <h4 class="mt">Hi {{$user->first_name}}</h4>
                             <h3 class="mb">Welcome!<span class="text-header"> </span></h3>
                             <p class="mb">  
                                We’re glad to have you onboard! we are glad to have you on our list of best teachers,
                                 on our secure, flexible and cost-effective platform <br>
                                 If there’s anything you need, we’ll be here every step of the way. You can contact our team experts at olukotideteam@gmail.com
                                 <br> 
                                Thank you.
                             </p>
                         </div>
